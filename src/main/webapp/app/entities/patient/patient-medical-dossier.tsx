...
export default function PatientDossierMedical() {
  ...
  const patient = sessionStorage.getItem('user_data');
  ...
  const loadDiagnostics = () => {
    console.log('hhhhhh', JSON.parse(patient).id);
    const patientId = JSON.parse(patient).id;
    axios
      .get('/api/diagnostics/dossiermedical/patient/' + patientId)
      .then(response => {
        console.log('hhhhh');
              ...
              {data.length > 0 && ( // Check if there is at least one element in the data array
                <MDBCardBody>
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{data[0].newPatientUserDTO.patient.user.firstName}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{data[0].newPatientUserDTO.patient.user.lastName}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{data[0].newPatientUserDTO.patient.user.email}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{data[0].newPatientUserDTO.patient.telephone}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{data[0].newPatientUserDTO.patient.adress}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                </MDBCardBody>
              )}
                        ...
                        <table className="table table-responsive " id="myTable">
                          <thead>
                            <tr>
                              ...
                              <th className="hand">Confirmed_Disease</th>
                          ...
                          <tbody>
                            {data.map((diagnostic, i) => (
                              <tr key={`entity-${i}`} data-cy="entityTable">
                                ...
                                <td>
                                  {diagnostic.newPatientUserDTO.dermatologue.user.firstName +
                                    ' ' +
                                    diagnostic.newPatientUserDTO.dermatologue.user.lastName}
                                </td>
